      ...
      <div className="members-wrapper">
        ...
        <div className="members-form-card">
         <div className="members-form-header">
            ...
            <span style={{ marginLeft: "960px" }}>ಸದಸ್ಯರ ಸಂಖ್ಯೆ: {number}</span>
          ...
          <form className="members-main-form" onSubmit={handleSubmit}>
            ...
            <div className="members-row members-row-3">
              ...
              />
              <TextField
                style={{ width: "322px", marginLeft: "5px" }}
                label="ಜನನ ದಿನಾಂಕ"
                name="dob"
                type="date"
              ...
              <div key={index} className="members-payment-block">
                <div className="members-row members-payment-row1">
                  <TextField label="ಮೊಬಲಾಗು " value={entry.payment} onChange={(e) => updateEntry(index, "payment", e.target.value)} size="small"
                    style={{ marginLeft: "0px", width: "355px" }} error={!!errors[`payment_${index}`]} helperText={errors[`payment_${index}`]} />
                  <TextField style={{ width: "355px", marginLeft: "5px" }} label="ಹಣ ಸ್ವೀಕರಿಸುವ ಪ್ರಕಾರ"
                    select
                  ...
                  <TextField style={{ width: "358px", marginLeft: "5px" }} label="ರಸೀದಿ ಸಂಖ್ಯೆ" value={entry.receipt} onChange={(e) => updateEntry(index, "receipt", e.target.value)} size="small" error={!!errors[`receipt_${index}`]} helperText={errors[`receipt_${index}`]} />
                </div>
                ...
                <div className="members-row members-payment-row2">
                  <TextField label="ಜಮಾ ವಿವರ" value={entry.deposit} onChange={(e) => updateEntry(index, "deposit", e.target.value)}
                    size="small" style={{ width: "1330px", }} error={!!errors[`deposit_${index}`]} helperText={errors[`deposit_${index}`]} />
                </div>


                {memberData.entries.length > 1 && (
                  <button style={{ marginLeft: "1250px" }} type="button" className="delete-entry-btn" onClick={() => { const updated = [...memberData.entries]; updated.splice(index, 1); setMemberData(prev => ({ ...prev, entries: updated })); }}>
                    🗑 ಅಳಿಸಿ
                  </button>
                )}
              </div>
